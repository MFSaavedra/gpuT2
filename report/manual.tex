...
\begin{sourcecode}{plaintext}{The strategy layout. Parenthesised entries are planned (only GuiRenderer).}
...
OpenCL results are folded into the report alongside CUDA. What is left is optional: a
\texttt{GuiRenderer} (the one planned-but-absent strategy), and the performance ideas
